<div align="center">
	...
	<form method="GET" action="atualizar_campos.php">
			
		<p> 
		<strong> Insira o ID do liente que deseja actualizar	<strong> <br>
		<input type="text" name="idcliente" size=30> </p>

		<input type="submit" value="Atulizar este cliente">
